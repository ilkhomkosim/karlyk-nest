...
export class PropertyResolver {
    ...
    public async createProperty(
        ...
        input.memberId = memberId;//kirib kelayotkan inputni MemberId siga request qilayotkan agent memberId sini olib beryapmiz. Chunki bu frontend dan kelmaydi deb property.inputda korsatkanmiz
    ...
    public async getFavorites(
        @Args('input') input: OdinaryInquiry,
        @AuthMember('_id') memberId: ObjectId,
    ): Promise<Properties> {
